...
unsigned char far viper[628] = {
17,39,5,1,114,6,1,115,7,4,137,11,1,115,12,4,114,24,3,185,27,7,228,254,1,1,115,2,36,232,254,0,1,114,1,1,64,2,1,65,3,3,64,6,1,12,7,1,64,8,3,42,11,1,41,12,1,232,13,1,41,14,1,136,15,1,18,16,4,209,20,6,136,26,1,232,27,11,42,38,1,232,254,0,1,232,1,1,163,2,1,64,3,1,42,4,7,41,11,1,113,12,1,19,13,1,136,14,1,41,15,3,139,18,1,138,19,3,232,22,1,138,23,3,137,26,13,41,254,0,1,232,1,1,163,2,1,12,3,7,232,10,1,41,11,1,18,12,1,19,13,1,210,14,8,12,22,3,42,25,2,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,232,1,1,64,2,8,41,10,1,232,11,1,18,12,1,19,13,1,137,14,1,12,15,12,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,12,1,1,65,2,8,41,10,1,232,11,1,18,12,1,19,13,1,138,14,1,12,15,12,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,64,1,1,65,2,8,41,10,1,232,11,1,18,12,1,19,13,1,163,14,1,42,15,12,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,64,1,1,65,2,8,41,10,1,232,11,1,18,12,1,19,13,1,232,14,13,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,64,1,1,65,2,8,41,10,1,232,11,1,18,12,1,19,13,1,232,14,13,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,12,1,1,65,2,8,41,10,1,232,11,1,18,12,1,19,13,1,232,14,1,42,15,12,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,232,1,1,65,2,1,42,3,8,41,11,1,18,12,1,19,13,1,137,14,1,42,15,12,41,27,1,232,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,232,1,1,164,2,1,12,3,8,41,11,1,208,12,1,19,13,1,210,14,1,42,15,12,41,27,1,136,28,1,19,29,1,18,30,1,136,31,8,41,254,0,1,232,1,1,163,2,1,12,3,8,41,11,1,113,12,1,19,13,1,136,14,1,232,15,10,42,25,4,41,29,2,232,31,8,41,254,0,1,114,1,1,12,2,2,64,4,1,12,5,5,42,10,3,41,13,1,136,14,1,209,15,10,19,25,1,136,26,12,42,38,1,232,254,1,1,113,2,10,232,12,4,113,16,21,232,37,1,112,254,4,1,185,5,1,114,6,5,137,11,1,113,12,4,114,25,5,228,30,4,227,255
};
        ...
        if (!(enemy[i].flags & ENEMY_ACTIVE)) {
            ...
            if (ai == STANDART_AI)
            	...
            	if (y_target_counter == 0) 
            		{
            		enemy[i].y_target = 15<<4;
            		y_target_counter = 1;
            		}
            	else 
            		{
            		enemy[i].y_target = 50<<4;
            		y_target_counter = 0;
            		}
            	}
        ...
        if (enemy[i].ai == STANDART_AI)
        	...
        	//Gestion vitesse
       		...
       		if (enemy[i].box.y > 0)
       			...
       			else if (enemy[i].vy_engine<90) enemy[i].vy_engine =90;
       			}
       			
       		//enemy[i].vy_engine = (enemy[i].vy_engine * 7) >> 3;
       	
       		
        	/*if (enemy[i].box.y>enemy[i].y_target) enemy[i].vy_engine+=7;
        	else if (enemy[i].box.y<enemy[i].y_target) enemy[i].vy_engine-=7;*/
